...
<details>
  ...
  <ol>
    ...
    <li><a href="#благодарность">Благодарности</a></li>
  </ol>
</details>
...
SIC (Safe Intra-school Communication) - безопасное внутришкольное общение.  
...
#### Над всеми недочетами идет работа, и пока я вам представлю первую версию — Платформа SIC v1.0.
...
Здесь представлены некоторые библиотеки, которыми я пользовался при создании проекта.
...
## Благодарность
  ...
  В первую очередь, хочу выразить слова благодарности [@DMGolD](https://t.me/DMGolD) и [Inke](https://vk.com/antijana) за моральную поддержку на протяжении всего времени реализации проекта.  
